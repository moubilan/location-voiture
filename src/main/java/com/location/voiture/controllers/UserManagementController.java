...
import com.location.voiture.services.UserManagementService;
...
public class UserManagementController {
    ...
    public ResponseEntity<ReqRes> updateUser(@PathVariable Integer userId, @RequestBody OurUser reqres){
